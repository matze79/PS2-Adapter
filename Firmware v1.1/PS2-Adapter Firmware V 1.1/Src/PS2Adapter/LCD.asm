...
.equ LCD_DatenMask0 = ~( (0x01 << LCD_PinDB0) | (0x01 << LCD_PinDB1) | (0x01 << LCD_PinDB2) | (0x01 << LCD_PinDB3))
.equ LCD_DatenMask1 = ( (0x01 << LCD_PinDB0) | (0x01 << LCD_PinDB1) | (0x01 << LCD_PinDB2) | (0x01 << LCD_PinDB3))
...
LCD_Initialize:
	...
	ori ax, LCD_DatenMask1						; unsere benutzten Pins DB0 bis DB3 auf Ausgang setzen
...
LI1:	
	...
	andi bx, LCD_DatenMask0						; nur die BITs erhalten, die nicht zu unseren Datenports gehören

												; eine $3 soll ausgeben werden
	ldi ax, ((0x01 << LCD_PinDB0) | (0x01 << LCD_PinDB1))
	or ax, bx									; alten Stand des Datenports hinzufügen
	out LCD_DatenPort, ax						; und ausgeben 
	ldi cx, 3									; Schleifenzähler setzen - zusammen muss $3 dreimal ausgegeben werden
LI2:	
...
LCD_Send:
	...
	out LCD_SteuerDDR, ax						; DDR der Steuerleitungen zurückschreiben
	in ax, LCD_DatenDDR							; DDR der Datenleitungen einlesen
	ori ax, LCD_DatenMask1
;	ori ax, (0x01 << LCD_PinDB0)				; unsere benutzten Pins DB0 bis DB3 auf Ausgang setzen
;	ori ax, (0x01 << LCD_PinDB1)
;	ori ax, (0x01 << LCD_PinDB2)
;	ori ax, (0x01 << LCD_PinDB3)
	out LCD_DatenDDR, ax						; DDR der Datenleitungen zurückschreiben
...
LCD_DatenbitVerschieben:
	...
	ldi bx, 0
	sbrc ax, 0 
	ori bx, (0x01 << LCD_PinDB0)
	sbrc ax, 1	
	ori bx, (0x01 << LCD_PinDB1)
	sbrc ax, 2	
	ori bx, (0x01 << LCD_PinDB2)
	sbrc ax, 3	
	ori bx, (0x01 << LCD_PinDB3)
	mov ax, bx
	pop bx
	ret
